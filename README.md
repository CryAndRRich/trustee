...
Dự án giải quyết bài toán hồi quy (Regression) trong lĩnh vực khai phá dữ liệu giáo dục. Mục tiêu cốt lõi là dự báo sớm số tín chỉ thực tế mà sinh viên sẽ hoàn thành (TC_HOANTHANH) trong kỳ học. Hệ thống không chỉ đưa ra dự đoán chính xác mà còn tập trung vào tính giải thích (Explainability), giúp nhà trường và sinh viên chủ động điều chỉnh lộ trình học tập để giảm thiểu rủi ro trượt môn hay chậm tiến độ.
